...
//This will track the order by entering orderid and emailid of the user who has ordered a product.
  ...
  public void trackingOrder() throws DocumentException 
  {
	 
	  trackObj.login();	  
	  trackObj.findtrackOrder().click();	  
	  trackObj.findorderid().sendKeys("9");	  
	  trackObj.findEmail().sendKeys(trackObj.emailId);	  
  ...
  {
	  trackObj.findtrackOrder().click();  
	  trackObj.findorderid().sendKeys(trackObj.invalidOrderId);	  
	  trackObj.findEmail().sendKeys(trackObj.invalidEmail); // This email id does not exist in the database. 
	  trackObj.findTrackButton2().click(); 
...
//instantiate the browser and login  
  ...
  public void setUp() throws DocumentException {
	  ...
	  trackObj.getsite();
	  trackObj.login();
	  trackObj.invalidEmailOrderidRead();
  }
