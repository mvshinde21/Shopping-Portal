...
//			locating a web element button called fashion
			fashion = driver.findElement(By.xpath("//*[@id=\"mc-horizontal-menu-collapse\"]/div/ul/li[5]/a"));
...
//			locating a web element image named product rating
			productRating = driver.findElement(By.id("rateit-range-3"));
...
//			locating a web element image named product mrp
			productMrp = driver.findElement(By.xpath("//*[@id=\"grid-container\"]/div/div/div[2]/div/div/div[2]/div[3]/span[2]"));
//			highlighting the button found or to be clicked
